...
class SQLHelper {
  ...
  static Future<int> createContact(String name, String? image, int number) async {
    final db = await SQLHelper.db();
    String num = number.toString();
    final contact = {'name': name, 'image': image, 'number': num};
  ...
  static Future<int> updateContact(
      int id, String name, String? image, int number) async {
    final db = await SQLHelper.db();
    String num = number.toString();
    final contact = {'name': name, 'image': image, 'number': num};
